                                                                    ...
                                                                    <tr>
                                                                        <td valign="top">
                                                                            <asp:GridView ID="grdMediaStatusReport" runat="server" AutoGenerateColumns="False"
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:BoundField DataField="ContentTitle" HeaderText="Content Title" ItemStyle-Wrap="true" ItemStyle-Width="100px" />
                                                                                    <asp:BoundField DataField="Module" HeaderText="Module Name" ItemStyle-Width="75px" />
                                                                                    ...
                                                                                    <asp:BoundField DataField="Sent_Date" HeaderText="Date"  ItemStyle-Width="165px"/>
                                                                                </Columns>
                ...
                <tr>
                    <td align="center" style="padding-left: 343px;">
                        <asp:Button ID="btnDashboard" Text="Dashboard" runat="server" OnClick="btnDashboard_Click"
                            CssClass="btn" Style="text-align: center;" />
                    </td>
                </tr>
            </table>
        </ContentTemplate>
